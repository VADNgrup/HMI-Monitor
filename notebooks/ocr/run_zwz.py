...
# Input setup based on run_cosmos.py
try:
    ...
    images_to_process = [image1, image2, image3, image5] #
    # images_to_process = [image1, image2] # Add others if they exist
except FileNotFoundError:
    images_to_process = []


question = """
What information showed in this HMI screen? Extract the information in Markdown format
    ...
    messages = [
        {
            ...
            "content": [
                ...
                {"type": "text", "text": question_prefix + question},
            ],
        }
    ]
